...
// import { schedule-table } from "."
import { DataTable } from '../../../components/AtomicDesign/organisms/scheduleTable/schedule-table';
import { PagesColumns } from '../../../components/AtomicDesign/organisms/scheduleTable/schedule-columns';
...
export default function Page() {
  return (
    <div className="h-lvh bg-slate-400">
      <hr className="m-1" />
      RLeaguez Schedulez Table Demo
      <br />
      <br />


      < DataTable columns={PagesColumns}  />
        type="button"
